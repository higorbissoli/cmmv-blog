                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="flex-grow">
                            ...
                            <div class="lg:col-span-3 bg-white rounded-lg p-4 relative">
                                <div class="w-full mx-auto overflow-hidden">
                                    ...
                                    <div v-if="post.featureImage" class="post-featured-image relative overflow-hidden rounded-lg max-h-[400px]">
                                        <div v-if="post.categories && post.categories.length > 0" class="absolute bottom-4 left-8 z-10 flex flex-wrap gap-2">
                                            <a v-for="category in post.categories" :key="category.id" :href="`/category/${category.slug}`"
                                                class="px-3 py-1 bg-[#ffcc00] text-[#333] text-sm font-medium rounded-full shadow-sm hover:bg-[#e6b800] transition-all">
                                                {{ category.name }}
                                            </a>
                                        </div>
                        ...
                        />
                                    ...
                                    <header class="post-header my-8">
                                        ...
                                        <div class="post-meta flex items-center justify-between">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <!-- Telegram -->
                                                <a class="bg-[#0088cc] hover:bg-[#0077b5] w-8 h-8 rounded-full flex items-center justify-center text-white transition-colors"
                                                    rel="nofollow noopener"
                                                    :href="'https://t.me/share/url?url=' + encodeURIComponent(pageUrl) + '&text=' + encodeURIComponent(post.title)"
                                                    onclick="window.open(this.href, 'telegram-share', 'width=490,height=530');return false;"
                                    ...
                                    <!-- Tags & Categories - Movido para canto inferior esquerdo -->
                                    <div class="post-taxonomy mt-6">
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <div ref="relatedPostsObserver" class="min-h-[200px]">
                                            ...
                                            />
                                                            ...
                                                            <div v-if="relatedPost.categories && relatedPost.categories.length > 0" class="absolute bottom-2 left-2">
    ...
    try {
        ...
        if (commentSystem.value === 'disqus') {
            ...
            commentsContainer.appendChild(commentsTitle);
                    ...
                    // Reduced delay for faster comment loading
        setTimeout(() => {
            try {
...
const loadDisqusComments = () => {
    try {
        ...
        // Reduced delay and optimized Disqus loading
        setTimeout(() => {
            try {
...
const setupLazyLoading = () => {
    // Optimized intersection observer settings for better performance
    if (relatedPostsObserver.value) {
        relatedPostsObserverInstance.value = new IntersectionObserver(
            ...
            {
                rootMargin: '150px', // Reduced for faster loading
    ...
    if (commentsObserver.value) {
        commentsObserverInstance.value = new IntersectionObserver(
            ...
            {
                rootMargin: '200px', // Reduced for faster loading
                threshold: 0.05 // Lower threshold for earlier loading
            }
        );
